    ...
    <div x-data="{ sidebarOpen: false }" class="relative">
        <div class="grid gap-6 lg:grid-cols-[260px_minmax(0,1fr)]">
            ...
            <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'"
                   class="fixed inset-y-0 left-0 z-[1045] w-72 max-w-[85vw] bg-white p-4 shadow-2xl border-r border-slate-200 transform transition-transform duration-300 ease-out lg:static lg:w-auto lg:max-w-none lg:shadow-none lg:border-none lg:p-0 lg:h-fit lg:block lg:card overflow-y-auto">
                ...
                <div class="px-3 pt-2 pb-1 text-xs font-bold uppercase tracking-wider text-slate-400/80 hidden lg:block">Dashboard Penjual</div>
                <nav class="mt-1 lg:mt-3 grid gap-0.5 lg:gap-1.5">
                    <a href="{{ route('seller.listings.index') }}" 
                       @click="sidebarOpen = false"
                       class="flex items-center gap-3 px-3.5 py-3 lg:py-2.5 rounded-xl text-sm transition-all {{ request()->routeIs('seller.listings.index') ? 'bg-brand-primary/8 text-brand-primary font-bold ring-1 ring-brand-primary/10' : 'text-slate-600 font-medium hover:bg-slate-50 hover:text-slate-900' }}">
                    ...
                    <a href="{{ route('seller.listings.create') }}" 
                       @click="sidebarOpen = false"
                       class="flex items-center gap-3 px-3.5 py-3 lg:py-2.5 rounded-xl text-sm transition-all {{ request()->routeIs('seller.listings.create') ? 'bg-brand-primary/8 text-brand-primary font-bold ring-1 ring-brand-primary/10' : 'text-slate-600 font-medium hover:bg-slate-50 hover:text-slate-900' }}">
                        <svg class="size-4.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                    ...
                    <a href="{{ route('seller.listings.import.show') }}" 
                       @click="sidebarOpen = false"
                       class="flex items-center gap-3 px-3.5 py-3 lg:py-2.5 rounded-xl text-sm transition-all {{ request()->routeIs('seller.listings.import.show') ? 'bg-brand-primary/8 text-brand-primary font-bold ring-1 ring-brand-primary/10' : 'text-slate-600 font-medium hover:bg-slate-50 hover:text-slate-900' }}">
                        <svg class="size-4.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                    ...
                    <a href="{{ route('seller.competitor-analysis.index') }}" 
                       @click="sidebarOpen = false"
                       class="flex items-center gap-3 px-3.5 py-3 lg:py-2.5 rounded-xl text-sm transition-all {{ request()->routeIs('seller.competitor-analysis.*') ? 'bg-brand-primary/8 text-brand-primary font-bold ring-1 ring-brand-primary/10' : 'text-slate-600 font-medium hover:bg-slate-50 hover:text-slate-900' }}">
                        <svg class="size-4.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                    ...
                    <a href="{{ route('seller.market-demands.heatmap') }}" 
                       @click="sidebarOpen = false"
                       class="flex items-center gap-3 px-3.5 py-3 lg:py-2.5 rounded-xl text-sm transition-all {{ request()->routeIs('seller.market-demands.heatmap') ? 'bg-brand-primary/8 text-brand-primary font-bold ring-1 ring-brand-primary/10' : 'text-slate-600 font-medium hover:bg-slate-50 hover:text-slate-900' }}">
                        <svg class="size-4.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                    ...
                    <a href="{{ route('seller.profile.edit') }}" 
                       @click="sidebarOpen = false"
                       class="flex items-center gap-3 px-3.5 py-3 lg:py-2.5 rounded-xl text-sm transition-all {{ request()->routeIs('seller.profile.edit') ? 'bg-brand-primary/8 text-brand-primary font-bold ring-1 ring-brand-primary/10' : 'text-slate-600 font-medium hover:bg-slate-50 hover:text-slate-900' }}">
                        <svg class="size-4.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                ...
                <div class="mt-6 border-t border-slate-100 pt-4 px-2">
                    <a href="{{ route('sellers.show', auth()->id()) }}" target="_blank"
                       class="flex flex-col gap-1 text-[11px] font-bold text-brand-primary bg-brand-primary/5 hover:bg-brand-primary/10 p-2.5 rounded-xl border border-brand-primary/10 transition-all text-center">
                        <span>Lihat Profil Publik Anda</span>
                        <span class="text-[10px] text-slate-400 font-medium">Lihat peta listing agensi Anda →</span>
                    </a>
                </div>
            </aside>
